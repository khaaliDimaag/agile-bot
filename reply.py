# Source: https://github.com/palash96rox/bu-bot/blob/67712ae0bf453669f9f736973631566000b2344f/bots/reply.py
...
if __name__=='__main__':
  if not os.environ.get('KHAALI_REPLY'): exit('token not found')
  bot.run(os.environ['KHAALI_REPLY'])
